...
const ZoneContainers = require('./zone-containers.js'),
			PlanningDocs = require('./planning-docs.js'),
			MapLayer = require('./map-layer.js');
...
class ZoneLayer extends MapLayer{
	constructor({ legend, isActive, name, order, dataURL = '' } = {}){
		...
		this._planningDocs = new PlanningDocs({ folderURL: dataURL + '/planning_docs/' });
